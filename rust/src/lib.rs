...
pub const CRIMSON: &str = "#DC143C";
pub const DEEP_BLUE: &str = "#003893";
pub const WHITE: &str = "#FFFFFF";
pub const INK: &str = "#111111";
pub const IMAGINARY: &str = "#888888";
pub const MODES: [&str; 3] = ["color", "skeleton", "landmark"];
...
pub fn to_svg(g: &Geom, mode: &str) -> String {
