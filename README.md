...
## **National Flag of Nepal** (_The most mathematical flag in the world_)
...
```bibtex
@misc{pant2015flagofnepal,
  author       = {Pant, Ashok Kumar},
  title        = {National Flag of Nepal: The Most Mathematical Flag in the World},
  year         = {2015},
  howpublished = {GitHub repository},
  url          = {https://github.com/ashokpant/flag-of-nepal}
}
```
